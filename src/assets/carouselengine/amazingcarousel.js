    ...
    $.fn.amazingcarousel = function(options) {
        ...
        AmazingCarousel.prototype = {
            ...
            embedHTML5Video: function($container, src, autoPlay) {
                if (ACPlatforms.isFirefox() && this.options.nativecontrolsonfirefox || (ACPlatforms.isIE6789() || ACPlatforms.isIE10() || ACPlatforms.isIE11()) && this.options.nativecontrolsonie || ACPlatforms.isIPhone() && this.options.nativecontrolsoniphone ||
                    ACPlatforms.isIPad() && this.options.nativecontrolsonipad || ACPlatforms.isAndroid() && this.options.nativecontrolsonandroid) this.options.nativehtml5controls = true;
                if (ACPlatforms.isIOS() || ACPlatforms.isAndroid()) this.options.nativecontrolsonfullscreen = true;
                $container.html("<div class='amazingcarousel-video-container-" + this.id + "' style='position:relative;display:block;width:100%;height:100%;'><video class='carousel-inline-video' style='width:100%;height:100%;'" + (this.options.nativehtml5controls && !this.options.videohidecontrols ?
                    " controls='controls'" : "") + (this.options.nativecontrolsnodownload ? " controlsList='nodownload'" : "") + "></div>");
                $("video", $container).get(0).setAttribute("src", src);
                if (autoPlay) $("video", $container).get(0).play();
                if (!this.options.nativehtml5controls && !this.options.videohidecontrols) {
                    $("video", $container).data("src", src);
                    $("video", $container).acHTML5VideoControls(this.options.skinsfolder, this, ".carousel-inline-video", this.options.videohidecontrols, this.options.videohideplaybutton, this.options.defaultvideovolume,
                        this.options.nativecontrolsonfullscreen, this.options.nativecontrolsnodownload, null)
                }
            },
            ...
            createItemBackgroundImage: function() {
                ...
                var background = "<div class='amazingcarousel-background-image' " + "style='display:block;position:absolute;left:" + l + "%;top:" + this.options.itembackgroundimagetop + "%;width:" + this.options.itembackgroundimagewidth + "%;height:auto;'>" + "<img src='../../../assets/images/carousel-images/" + this.options.itembackgroundimage + "' style='display:block;position:relative;width:100%;height:auto;" + "border:0;box-shadow:none;-moz-box-shadow:none;-webkit-box-shadow:none;border-radius:0;-moz-border-radius:0;-webkit-border-radius:0;" +
                    "' />" + "</div>";
            ...
            createBackgroundImage: function() {
                ...
                var background = "<div class='amazingcarousel-background-image' " + "style='display:block;position:absolute;left:" + l + "%;top:" + this.options.backgroundimagetop + "%;width:" + this.options.backgroundimagewidth + "%;height:auto;'>" + "<img src='../../../assets/images/carousel-images/" + this.options.backgroundimage +
                    "' style='display:block;position:relative;width:100%;height:auto;" + "border:0;box-shadow:none;-moz-box-shadow:none;-webkit-box-shadow:none;border-radius:0;-moz-border-radius:0;-webkit-border-radius:0;" + "' />" + "</div>";
            ...
            createNavBullet: function(index) {
                ...
                $(".custom-amazingcarousel1-bullet-0").click(function() {
                    var bulletIndex = 0;
                    if (instance.options.navmode ==
                        "page") bulletIndex = instance.visibleItems * bulletIndex;
                    instance.slideRun(bulletIndex, true)
                ...
                $(".custom-amazingcarousel1-bullet-1").click(function() {
                    var bulletIndex = 1;
                    if (instance.options.navmode ==
                        "page") bulletIndex = instance.visibleItems * bulletIndex;
                    instance.slideRun(bulletIndex, true)
                ...
                $(".custom-amazingcarousel1-bullet-2").click(function() {
                    var bulletIndex = 2;
                    if (instance.options.navmode ==
                        "page") bulletIndex = instance.visibleItems * bulletIndex;
                    instance.slideRun(bulletIndex, true)
                ...
                $(".custom-amazingcarousel1-bullet-3").click(function() {
                    var bulletIndex = 3;
                    if (instance.options.navmode ==
                        "page") bulletIndex = instance.visibleItems * bulletIndex;
                    instance.slideRun(bulletIndex, true)
